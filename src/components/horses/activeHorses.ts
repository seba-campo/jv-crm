...
class ActiveHorses extends HTMLElement{
    ...
    async connectedCallback(){
        const caballos = await state.getActiveHorses();
    ...
    render(){
        ...
        console.log(listaDeCaballosJSON)

        div.innerHTML = /*html*/`
            <div class="root">

                <div class="root-title"><page-title title="Caballos activos a la fecha"></page-title></div>
                ...
                <div class="table-container">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        ${
                            listaDeCaballosJSON.map((e: Horse)=>{
                                return `
                                    <tr>
                                        <td>${e.nombre}</td>
                                        <td>${e.pelaje}</td>
